    ...
    <form action="" method="post"  class="form-horizontal" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <input type="text" id="inputError" name="date" value="<?php echo $insertInfo['date']; ?>">
            ...
            <div class="control-group hidden-phone">
                ...
                <div class="controls">
                    <textarea name="text" class="cleditor" id="textarea2" rows="3"><?php echo $insertInfo['text']; ?></textarea>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
                <input type="submit" name="editNews" value="Add News" class="btn btn-primary"/>
            </div>
        </fieldset>
    </form>
