    ...
    <div class="content">
        ...
        <div class="section group">
            ...
            <div class="grid_1_of_4 images_1_of_4">
                <a href="index.php?c=item&m=preview&id=<?php  echo $lastItem->getId(); ?>"><img src="http://softacad.dev/MVS%20MYSHOP/admin/uploads/<?php echo $lastItem->getImage(); ?>" alt="" width="150px" height="150px" /></a>
                <h2><?php echo $lastItem->getName(); ?></h2>
                <div class="price-details">
                    <div class="price-number">
                        <p><span class="rupees"><?php echo $lastItem->getPrice(); ?> лв.</span></p>
                    </div>
                    <div class="add-cart">
